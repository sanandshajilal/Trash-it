				...
				<div class="row">
					<div class="col-md-12">
						<div class="calltoaction-wrapper">
						 <a href="#service" class="btn hvr-bubble-bottom page-scroll">Need a Pick Up ?</a>
						</div>
					</div>
				</div>
			</div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-3">
          ...
          <div id="myModal1" class="modal" data-easein="slideLeftIn"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                  <h4 class="modal-title">BOOK YOUR PICKUP !</h4>
                </div>
          ...
          <div id="myModal3" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                  <h4 class="modal-title">SELL OFF YOUR SCRAP !</h4>
                </div>
                <div class="modal-body">
                  <p>Description</p>
                </div>
          ...
          <div id="myModal4" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                  <h4 class="modal-title">GET PAID !</h4>
                </div>
                <div class="modal-body">
                  <p>Description</p>
                </div>
    ...
    <div class="container">
        <div class="row">
          <div class="col-lg-6">
            ...
            <br/>
            <br/>
            <form id="loginform" name="login_form" action="login.php">
            <div class="form-group">
